...
venue: "GCB Academy"        # brief name of host site without address (e.g., "Euphoric State University")
...
humandate: "Nov 4 – 5, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
helper: ["Valerie Gartner (Biology)", "Zachery Mielko (UPGG)"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: "https://hackmd.io/8skPkBILQJe3x91Ij6YXOA"            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
...
<p id="requirements">
  ...
  Mac, Linux, or Windows operating system (not a tablet, Chromebook, etc.) that they have administrative privileges on. They should have a few specific software packages installed (listed <a href="#setup">below</a>). Some basic familiarity with Linux (or Unix), such as from an <a href="https://colab.duke.edu/roots/course/bash-01" target="_blank">Introduction to Unix and Bash</a> class, is assumed.
</p>
...
<ul>
  <li>The EDGE Workshop room is wheelchair / scooter accessible.</li>
